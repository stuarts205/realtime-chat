  ...
  return (
    <main className="flex flex-col h-screen max-h-screen overflow-hidden bg-black">
      <header className="border-b border-zinc-800 p-4 flex items-center justify-between bg-zinc-900/30">
        <div className="flex items-center gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 
                rounded text-zinc-400 hover:text-zinc-200 transition-colors"
          ...
          <div className="flex flex-col">
            ...
            <span
              className={`text-xs font-bold flex items-center gap-2} ${timeRemaining !== null && timeRemaining < 60 ? "text-red-500" : "text-amber-500"}`}
            >
        ...
        text-zinc-400 hover:text-white font-bold transition-all group flex items-center gap-2 disabled:opacity-50"
        >
          ...
          <div className="flex-1 relative group">
            ...
            <input
              ...
              className="w-full bg-black border border-zinc-800 focus:border-zinc-700 focus:outline-none 
                transition-colors text-zinc-100 placeholder:text-zinc-700 py-3 pl-8
                pr-4 text-sm"
            />
          </div>
          <button
            ...
            className="bg-zinc-800 text-zinc-400 px-6 text-sm font-bold hover:text-zinc-200 
